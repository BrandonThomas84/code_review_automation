...
1. **Customize the workflow** (optional)
...
2. Add these secrets (AUTOREVIEW_ prefix for namespace isolation):
...
> **Note:** Legacy variable names (SMTP_HOST, SMTP_USER, etc.) are still supported as fallbacks for backward compatibility.
